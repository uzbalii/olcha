...
function Seasonal() {
  return (
      <div className="seasonal">
          ...
          <img className='left_img' src="https://olcha.uz/image/272x444/homePage/cdn_1/2024-10-21/l8PPzsrJpBNpjXe7ddr8p4tzDwYpSzz2rywiHn29ljRm2CqXBCvHZU52kdly.jpg" alt="" />
      </div>
  )
}
